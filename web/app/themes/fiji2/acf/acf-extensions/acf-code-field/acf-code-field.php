...
function acf_check() {
	if ( ! class_exists( 'acf' ) && current_user_can( 'manage_options' ) ) {
		...
		$message = sprintf( __( 'Uh-oh. ACF not installed. Please install the <a href="%s" class="thickbox">Advanced Custom Fields plugin.</a>', 'flotheme' ), '/wp-admin/plugin-install.php?tab=plugin-information&plugin=advanced-custom-fields&TB_iframe=true&width=600&height=550' );
