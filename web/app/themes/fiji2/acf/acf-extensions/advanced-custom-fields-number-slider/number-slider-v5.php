...
class acf_field_number_slider extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Number Slider', 'flotheme');
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Units','flotheme'),
			'instructions'	=> __('Enter the units to measure by','flotheme'),
			'type'			=> 'text',
			'name'			=> 'slider_units',
		));
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Enter the default value','flotheme'),
			'type'			=> 'number',
			'name'			=> 'default_value',
		));
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum Value','flotheme'),
			'instructions'	=> __('Enter the minimum value to allow','flotheme'),
			'type'			=> 'number',
			'name'			=> 'slider_min_value',
		));

		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum Value','flotheme'),
			'instructions'	=> __('Enter the maximum value to allow','flotheme'),
			'type'			=> 'number',
			'name'			=> 'slider_max_value',
		));

		acf_render_field_setting( $field, array(
			'label'			=> __('Increment Value','flotheme'),
			'instructions'	=> __('Enter the value to increment by','flotheme'),
			'type'			=> 'number',
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		$dir = get_template_directory_uri() . '/acf/acf-extensions/advanced-custom-fields-number-slider/';
