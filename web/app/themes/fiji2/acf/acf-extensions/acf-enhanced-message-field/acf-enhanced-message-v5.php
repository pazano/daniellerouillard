	...
	class ACF_Field_Enhanced_Message extends acf_field {
		...
		*/
		...
		function __construct( $settings ) {
			...
			$this->label = __( 'Enhanced Message','flotheme' );
...
//			$dir = plugin_dir_url( __FILE__ );
			...
			$dir = get_template_directory_uri().'/acf/acf-extensions/acf-enhanced-message-field/';
		...
		*/
		...
		function render_field_settings( $field ) {
			...
			acf_render_field_setting( $field, array(
				'label'			=> __('Message','flotheme'),
				'instructions'	=> __('Works like the default Message field but supports PHP and without ','flotheme') . '<a href="http://codex.wordpress.org/Function_Reference/wpautop" target="_blank">wpautop()</a>',
				'type'			=> 'textarea',
