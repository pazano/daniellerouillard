(function($){
  ...
  */
  ...
  var acf_settings_flo_flexible_content = acf.field_group.field_object.extend({
  ...
  acf_settings_flo_flexible_content.layout = acf.model.extend({
    ...
    */
    ...
    _delete: function( $el ){
      ...
      if( $el.siblings('.acf-field-setting-fc_layout').length == 0 ) {
        ...
        alert( acf._e('flo_flexible_content','layout_warning') );
