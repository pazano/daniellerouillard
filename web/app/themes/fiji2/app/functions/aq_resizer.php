...
if(!function_exists('aq_resize')) {
	 ...
	 */
	function aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false, $size_force = false ) {
		//if retina display then double sizes
		if(!$size_force){
			if(isset($_COOKIE["flo_device_pixel_ratio"]) &&
				$_COOKIE["flo_device_pixel_ratio"] >=2 &&
				!(isset($_COOKIE['flo_small_screen']) &&
					$_COOKIE['flo_small_screen'] == '1' ) ){
