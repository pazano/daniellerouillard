<div class="flo-launch-walkthrough-popup--wrapper">
  ...
  <div class="flo-launch-walkthrough-popup--inner">
    ...
    <div class="flo-launch-walkthrough-popup--head">
      ...
      <div class="flo-launch__compatibility-steps-navigation">
        ...
        <div class="flo-launch__compatibility-steps-navigation-item" data-index="4">4</div>
        <div class="flo-launch__compatibility-steps-navigation-item" data-index="5">5</div>
        <div class="flo-launch__compatibility-steps-navigation-item" data-index="6">6</div>
      </div>
    ...
    <div class="flo-launch-walkthrough-popup--body">
      ...
      <div class="flo-launch__compatibility-steps--info-wrapper">
        <div class="flo-launch__compatibility-steps--info-step active" data-index="default">
          <h3 class="flo-launch__compatibility-steps--info-step--title">Compatibility Check is in progress</h3>
        ...
        <div class="flo-launch__compatibility-steps--info-step" data-index="4">
          ...
          <div class="flo-launch__compatibility-steps--info-step-column">
            ...
            <div class="flo-launch__compatibility-steps--info-step--message">
              Your server memory limit value (<?php echo ini_get('memory_limit'); ?>) is below the recommended value (256MB).
        ...
        <div class="flo-launch__compatibility-steps--info-step" data-index="final">
          <h3 class="flo-launch__compatibility-steps--info-step--title">Compatibility Test is successfully finished & you are all set up to continue to Backup Step.</h3>
        </div>
      </div>
    </div>
    <div class="flo-launch-walkthrough-popup--footer">
      <div class="flo-launch-walkthrough-popup--process">
        <h3 class="flo-launch-walkthrough-popup--status"></h3>
        <?php
          $uploads = wp_upload_dir();
          echo floRenderButton($uploads['baseurl'] . '/flo-launch-backups/flo-launch-logs.log', array(), array('s', 'white', 'border'), '', 'Download Report' );
          echo floRenderButton('#', array(), array('r', 'orange'), 'js-open-step-backup', 'Proceed to Backup Step' );
        ?>
        <a href="#" data-handler="js-start-over-compatibility"><i class="flo-launch__compatibility-icon flo-launch-icon-restart"></i>Start Over</a>
